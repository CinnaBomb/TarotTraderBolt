-- Sample tarot cards to populate the database
...
-- Check if we successfully inserted the cards
SELECT COUNT(*) as total_cards, 
       COUNT(CASE WHEN card_type = 'major' THEN 1 END) as major_arcana,
       COUNT(CASE WHEN card_type = 'minor' THEN 1 END) as minor_arcana
FROM tarot_cards;
